...
class IntStackSuite extends AnyFunSuite {
  ...
  test("Can equal") {
    val s1234 = Empty.push(1).push(2).push(3).push(4)
    val s5678 = Empty.push(5).push(6).push(7).push(8)
    var s12345678 =
      Empty.push(1).push(2).push(3).push(4).push(5).push(6).push(7).push(8)

    assert(s1234.pushAll(s5678).equals(s12345678))
  }
}
